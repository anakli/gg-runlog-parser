...
# python plot-per-lambda-throughput-3graphs.py gg-cmake-s3netstats-1000lambdas-REDO sort100GB-500worker-netstatsTX video3-4k-b50-s3-rxstats.txt
...
sort = ax3.plot(x, np.transpose(yavg), label='video-analytics-500workers', color='#ff7f0e', linewidth=3)
ax3.set_xlim(0, 10)
#a32.set_ylim(0, 0.1)
...
rxstats.close()
#plt.show()
fig.text(0.02, 0.5, 'Avg. MB/s per Lambda', ha='center', va='center', rotation='vertical')
fig.tight_layout()
